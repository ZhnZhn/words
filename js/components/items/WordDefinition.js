...
var WordDefinition = (_temp2 = _class = function (_Component) {
  (0, _inherits3.default)(WordDefinition, _Component);
  ...
  function WordDefinition() {
    ...
    (0, _classCallCheck3.default)(this, WordDefinition);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = WordDefinition.__proto__ || Object.getPrototypeOf(WordDefinition)).call.apply(_ref2, [this].concat(args))), _this), _this._renderDefinitions = function () {
  ...
  (0, _createClass3.default)(WordDefinition, [{
    key: 'render',
...
//# sourceMappingURL=D:\_Dev\_React\_Words\js\components\items\WordDefinition.js.map